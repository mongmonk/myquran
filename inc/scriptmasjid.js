...
function writeIslamicDate(adjustment) {
  var wdNames = new Array("Ahad","Isnin","Tsulatsa","Arba`a","Khamis","Jumu`ah","Sabt");
  var iMonthNames = new Array("Muharram","Shafar","Rabi'ul Awal","Rabi'ul Akhir","Jumadal Ula","Jumadal Akhir","Rajab","Sya'ban","Ramadhan","Syawal","Dhulqa'da","Dhulhijjah");
