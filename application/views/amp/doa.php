      ...
      <ul class="list-reset">
        <?php 
            foreach($data as $i => $list){?>
              <li class="mb2 px3">
                  <h2 class="h4"><?php echo $list->id ?>. <?php echo $list->doa ?></h2>
                  <p class="arab text-right my1"><?php echo $list->ayat ?></p>
                  <p class="my1 text-right"><em><?php echo $list->latin ?></em></p>
                  <p class="my1"><b>Artinya:</b> <?php echo $list->artinya ?></p>
                  <div class="dash"></div>
              </li>
        <?php }?>
      </ul>
