    ...
    <main id="content" role="main" class="pt4">
      <article class="recipe-article center border-bottom pt4">
        <header>
          ...
          <h1 class="h2"><a href="<?php echo base_url("surah/{$data->nomor}")?>"><?php echo $title ?></a></h1>
          <p class="my2 justify"><?php echo $data->deskripsi ?></p>
          <amp-audio class="my2" width="auto" height="50" src="<?php echo $data->audio ?>" autoplay>
      ...
      <ul class="list-reset">
        <?php foreach($data->tafsir as $i => $list){?>
            <li class="mb2 px3">
              <a href="<?php echo base_url("ayah/{$list->ayat}")?>">[ <?php echo $list->ayat ?> ]</a>. <?php echo $list->tafsir ?>
              <div class="dash"></div>
            </li>
        <?php }?>
      </ul>
