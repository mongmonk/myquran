...
<html ⚡="" lang="id-ID">
  ...
  <body>
    ...
    <main id="content" role="main" class="pt4">
      ...
      <ul class="bold column-2 center">
        <?php foreach($data as $i => $ruku){ $urut = $i+1;?>
            <li class="mb2 px3">
                <a href="<?php echo base_url("ruku/{$ruku->ruku}")?>">ركوع  <?php echo $this->quran->numConverter($ruku->ruku) ?> , <?php echo $ruku->surahAr ?></a>
            </li>
        <?php }?>
      </ul>
    </main>
