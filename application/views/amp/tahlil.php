        ...
        <?php 
          if($data){
            foreach($data->result as $i => $list){?>
              <li class="mb2 px3">
                  <p class="mb2"><?php echo $list->no ?>. <?php echo $list->judul ?></p>
                  <p class="text-right arab my1"><?php echo $list->arab ?></p>
                  <p class="my1 pt1"><span class="btn">ID Translation</span> <?php echo $list->id ?></p>
                  <div class="dash"></div>
              </li>
